...
import {ChipActivationV2 as ChipActivation} from "../../src/activation/ChipActivationV2.sol";
...
contract ChipActivationTestV2Regression is Test {
    ...
    function setUp() public virtual {
        ...
        act = new ChipActivation(multisig, address(chip), 0x000000000000000000000000000000000000dEaD, TIERS, 10_000, address(0));
    ...
    function test_aLyingChipCannotBuyAnActivationForFree() public {
        ...
        ChipActivation a2 =
            new ChipActivation(multisig, address(liar), 0x000000000000000000000000000000000000dEaD, TIERS, 10_000, address(0));
        vm.prank(multisig);
    ...
    function test_aPausedChipBlocksActivationWithoutCorruptingState() public {
        ...
        ChipActivation a2 = new ChipActivation(multisig, address(pt), 0x000000000000000000000000000000000000dEaD, TIERS, 10_000, address(0));
        vm.prank(multisig);
        a2.queueCosts(address(based), COSTS);
        vm.warp(block.timestamp + 48 hours);
        vm.prank(multisig);
