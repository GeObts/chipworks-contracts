...
## Forge output at 2943917 (after part 2)

- Non-fork: **954 passed, 0 failed** (48 suites). Box suites: 135 passed.
- `BoxFork.t.sol` on a Base mainnet fork with a keyed RPC: **1 passed** (`test_fullCycle_onRealPools`).
- Mutation re-run on the round-2 fixes (M4, M8, M16, L1, L3, L4 ×2, L6, I4): **9 of 9 killed.**
- Live-node callback sim (real B20s): 466,863 / 464,734 at 10 stocks, 566,259 / 573,892 at 13. See `gas/box-callback-sim.out.txt`.
